...
<div class="container mt-100">
    <div class="blog">
        <div class="blog-container">
            <header class="entry-header">
                <div class="entry-meta">
                    <div class="cat-links">
                        ...
                        <a href="{{route('/')}}" class="innak-font" rel="category tag"><strong>innak Blog</strong></a>
                    </div>
                </div>
                ...
                <div class="entry-meta d-flex flex-wrap align-items-center text-center text-md-left">
                    <div class="posted-on">
                        ...
                        <a href="{{route('/')}}"
                            rel="bookmark">
                            <time class="entry-date published" datetime="2020-09-19T12:09:47+00:00">April 18,
                                2024</time> </a>
                    </div>
                    <div class="read-time">
            ...
            <figure class="">
                <img src="{{asset('images/blog/the-future-of-web-development-trends-and-nnovations.png')}}" class="" alt
                    loading="lazy">
            </figure>
                    ...
                    <ul class="social-icon">
                        <li>
                            <a rel="nofollow" target="_blank"
                                href="https://twitter.com/intent/tweet?text=The Future of Web Development: Trends and Innovations&amp;url={{round('blog1')}}">
                        ...
                        <li>
                            <a rel="nofollow" target="_blank"
                                href="https://www.facebook.com/sharer/sharer.php?u={{round('blog1')}}"><svg
                        ...
                        <li>
                            <a rel="nofollow" target="_blank"
                                href="https://www.linkedin.com/shareArticle?mini=true&amp;url={{round('blog1')}}&amp;title=The Future of Web Development: Trends and Innovations"><svg
                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                    stroke-linejoin="round"
